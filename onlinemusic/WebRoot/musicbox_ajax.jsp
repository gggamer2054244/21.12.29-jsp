	...
	<TABLE width="100%" align="center" class="mytable">
		...
		<%
				...
				out.println("<div class=\"yahoo2\">"
      				...
      				+ "</div><br />");
				out
						.println("<div align=center> <label>选中项：<select name=select id=select class=width_100> <option value=del>删除</option> </select> </label> <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type=\"submit\"  value=提交> </label>  </div></FORM>");
				out.println("");
			} else {
			}
		%>
